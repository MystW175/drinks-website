    ...
    return (
        <div className="">
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <nav className="grid place-items-start gap-2 text-[14px] h-min flex-1 min-w-[150px]">
                    <header className="footer-title">Services</header>
                    <a className="link link-hover">Quality Testing</a>
                ...
                <nav className="grid place-items-start gap-2 text-[14px] h-min flex-1 min-w-[150px]">
                    ...
                    <a className="link link-hover">About the website</a>
